...
export default function BrandbookTool() {
  ...
  // Pre-fill form with user profile data OR workflow data from market analysis
  useEffect(() => {
    // First priority: Use workflow data from market analysis if available
    const workflowInput = getInputForAgent('brandbook')
    if (workflowInput?.businessIdea) {
      setBrandIdea(workflowInput.businessIdea)
      return
    }
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      console.log("[v0] Brandbook results saved to workflow context")
    } catch (err) {
      ...
      <div className="container mx-auto px-4 pb-12 max-w-6xl pt-[33px]">
        ...
        {results && (
          <div className="animate-in fade-in duration-700">
                  ...
                  <CardContent className="space-y-2">
                    {[
                      ...
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 rounded-md transition-colors duration-200 flex items-center space-x-2 ${activeSection === section.id
                              ...
                              <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg">
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    <div className="space-y-3 bg-white p-4 rounded-lg border border-red-200">
                                      <div className="flex items-start space-x-3">
            ...
            {/* Workflow Navigation */}
            <WorkflowNavigation
              currentAgent={WORKFLOW_STEPS.brandbook.name}
              nextAgent={WORKFLOW_STEPS.brandbook.next}
            />
          </div>
        )}
      </div>
